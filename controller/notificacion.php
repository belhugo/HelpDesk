<?php
    ...
    switch($_GET["op"]){
        ...
        case "actualizar";
            $notificacion->update_estado_no_leido($_POST["not_id"]);
            break;
        
        /* TODO:Actualizar estado segun not_id */
        case "leido";
            $notificacion->update__estado_leido($_POST["not_id"]);
            break;
        ...
        case "ticket_asignado":
            $notificacion->ticket_asignado($_POST["usu_asig"], $_POST["tick_id"]);
            break;
        case "comentario_soporte":
            $notificacion->comentario_soporte($_POST["usu_crea"], $_POST["tick_id"]);
            break;
        case "comentario_usuario":
            $notificacion->comentario_usuario($_POST["usu_asig"], $_POST["tick_id"]);
            break;
}
?>